...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var spinner_provincia: Spinner
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val spinneropciones = arrayOf("Valencia","Alicante","Castellón","Madrid")
        spinner_provincia.adapter = ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, spinneropciones)
